...
# --- input current  (constant between 10 and 40 ms) ---
I_ext = np.where((time_ms >= 10.0) & (time_ms <= 40.0), 10.0, 0.0)
# by choosing this input current, we can avoid time update in rk4 
# given that it's constant, we are going to see a spike train as an output
